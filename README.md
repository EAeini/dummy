...
- Investitions-, Betriebs- und ROI-Rechnung mit 35 % Stadtzuschuss als Beispiel
- Fließbild des Wärmepumpen- und Heizwasserkreislaufs
...
| `subsidy_source` | Zuschussgeber | `"Stadt"` |
...
- 35 % Zuschuss von der Stadt als Beispielannahme
